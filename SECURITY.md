...
We take security seriously. If you discover a security vulnerability in 章鱼哥AI, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **security@zhangyuge-agent.local**
...
- The 章鱼哥AI desktop application
- The `@zhangyuge-agent/*` npm packages
- Official 章鱼哥AI repositories
