...
/**
 * Validate path format for the current server platform without touching the filesystem.
 * Rejects cross-platform paths such as Windows drive letters on macOS/Linux.
 */
 ...
 * Existing directories are accepted. Non-existent paths are accepted only when
 * their nearest existing parent directory exists.
 */
