...
Shared TypeScript types and utilities for 章鱼哥AI applications.

## Installation

```bash
# In a workspace package
bun add @zhangyuge-agent/core
```
...
{
  "dependencies": {
    "@zhangyuge-agent/core": "workspace:*"
  }
}
```
...
import type {
  ...
  TokenUsage,
  AgentEvent,
} from '@zhangyuge-agent/core';

// Import utilities
import { generateMessageId, debug } from '@zhangyuge-agent/core';
```
...
- `AgentEvent` - Events from ZhangyugeAgent
