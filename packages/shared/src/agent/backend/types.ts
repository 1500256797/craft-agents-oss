 ...
 * The ZhangyugeAgent facade delegates to these backends, enabling provider switching while
 ...
 * - AsyncGenerator for streaming: Consistent with existing ZhangyugeAgent API
 */
 ...
 * 2. Enable the facade pattern in ZhangyugeAgent
