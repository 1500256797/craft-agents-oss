 ...
 * Extracted here so handler code in @zhangyuge-agent/server-core can import
 * from @zhangyuge-agent/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@zhangyuge-agent/core/types'
