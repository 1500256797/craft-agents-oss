 ...
 *
 * The mapping lives in ~/.zhangyuge-agent/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.zhangyuge-agent/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.zhangyuge-agent/tool-icons/ containing tool-icons.json and icon files
