 ...
 *
 * Watched paths:
 * - ~/.zhangyuge-agent/config.json - Main app configuration
 * - ~/.zhangyuge-agent/preferences.json - User preferences
 * - ~/.zhangyuge-agent/theme.json - App-level theme overrides
 * - ~/.zhangyuge-agent/themes/*.json - Preset theme files (app-level)
 * - ~/.zhangyuge-agent/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.zhangyuge-agent/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.zhangyuge-agent/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.zhangyuge-agent/permissions/)
