 ...
 * For filesystem operations, import from '@zhangyuge-agent/shared/labels/storage'.
 */
...
// Auto-labels: import directly from '@zhangyuge-agent/shared/labels/auto' to keep
