 ...
 *
 * Docs are stored at ~/.zhangyuge-agent/docs/ and synced from bundled assets.
...
export const APP_ROOT = '~/.zhangyuge-agent';
...
export const DOC_REFS = {
  ...
  zhangyugeAgentCli: `${APP_ROOT}/docs/zhangyuge-agent-cli.md`,
