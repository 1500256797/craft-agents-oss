...
describe('PromptHandler', () => {
  ...
  describe('environment variable expansion', () => {
    it('should expand $VAR syntax in prompt text', async () => {
      ...
      const configProvider = createMockConfigProvider({
        LabelAdd: [{
          actions: [{ type: 'prompt', prompt: 'Label $ZHANGYUGE_AGENT_LABEL was added' }],
        }],
      });
    ...
    it('should expand ${VAR} syntax in prompt text', async () => {
      ...
      const configProvider = createMockConfigProvider({
        LabelAdd: [{
          actions: [{ type: 'prompt', prompt: 'Label ${ZHANGYUGE_AGENT_LABEL} was added to ${ZHANGYUGE_AGENT_WORKSPACE_ID}' }],
        }],
      });
