# Contributing to 章鱼哥AI

Thank you for your interest in contributing to 章鱼哥AI! This document provides guidelines and instructions for contributing.
...
└── packages/
    ├── core/        # @zhangyuge-agent/core - Shared types
    ├── shared/      # @zhangyuge-agent/shared - Business logic
    └── ui/          # @zhangyuge-agent/ui - React components
```
