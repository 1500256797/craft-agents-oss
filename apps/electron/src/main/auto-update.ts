 ...
 * electron-updater library. Updates are served from https://agents.zhangyuge-agent.local/electron/latest
...
import { getAppVersion } from '@zhangyuge-agent/shared/version'
import {
  getDismissedUpdateVersion,
  clearDismissedUpdateVersion,
} from '@zhangyuge-agent/shared/config'
import { readJsonFileSync } from '@zhangyuge-agent/shared/utils/files'
