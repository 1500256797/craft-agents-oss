...
mock.module('@zhangyuge-agent/shared/config', () => ({
...
mock.module('@zhangyuge-agent/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@zhangyuge-agent/shared/agent', () => ({
...
mock.module('@zhangyuge-agent/shared/agent/backend', () => ({
...
mock.module('@zhangyuge-agent/shared/sources', () => ({
...
mock.module('@zhangyuge-agent/shared/automations', () => ({
...
mock.module('@zhangyuge-agent/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@zhangyuge-agent/server-core/sessions')
