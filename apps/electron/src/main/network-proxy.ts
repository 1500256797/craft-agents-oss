...
import { getNetworkProxySettings, setNetworkProxySettings } from '@zhangyuge-agent/shared/config/storage';
import type { NetworkProxySettings } from '@zhangyuge-agent/shared/config/types';
