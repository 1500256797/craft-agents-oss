...
export const CHANNEL_MAP = {
  ...
  // Auth
  login: invoke(RPC_CHANNELS.auth.LOGIN),
  getCurrentUser: invoke(RPC_CHANNELS.auth.GET_CURRENT_USER),
  getAccountSessionState: invoke(RPC_CHANNELS.auth.GET_SESSION_STATE),
  getCaptchaId: invoke(RPC_CHANNELS.auth.GET_CAPTCHA_ID),
  getCaptchaImage: invoke(RPC_CHANNELS.auth.GET_CAPTCHA_IMAGE),
  ...
  getChannelTypes: invoke(RPC_CHANNELS.channels.GET_TYPES),
  getUserChannels: invoke(RPC_CHANNELS.channels.GET_USER_CHANNELS),
  getChannelAccounts: invoke(RPC_CHANNELS.channels.GET_ACCOUNTS),
  getChannelsSnapshot: invoke(RPC_CHANNELS.channels.GET_SNAPSHOT),
  listModelProviders: invoke(RPC_CHANNELS.modelProviders.LIST),
  createModelProvider: invoke(RPC_CHANNELS.modelProviders.CREATE),
  updateModelProvider: invoke(RPC_CHANNELS.modelProviders.UPDATE),
  deleteModelProvider: invoke(RPC_CHANNELS.modelProviders.DELETE),
  updateModelProviderStatus: invoke(RPC_CHANNELS.modelProviders.SET_STATUS),
  listKnowledgeBases: invoke(RPC_CHANNELS.knowledgeBase.LIST),
  createKnowledgeBase: invoke(RPC_CHANNELS.knowledgeBase.CREATE),
  updateKnowledgeBase: invoke(RPC_CHANNELS.knowledgeBase.UPDATE),
  deleteKnowledgeBase: invoke(RPC_CHANNELS.knowledgeBase.DELETE),
  listKnowledgeDocuments: invoke(RPC_CHANNELS.knowledgeBase.LIST_DOCUMENTS),
  uploadKnowledgeDocument: invoke(RPC_CHANNELS.knowledgeBase.UPLOAD_DOCUMENT),
  deleteKnowledgeDocument: invoke(RPC_CHANNELS.knowledgeBase.DELETE_DOCUMENT),
  getKnowledgeTaskStatus: invoke(RPC_CHANNELS.knowledgeBase.GET_TASK_STATUS),
  ...
  getUiLanguage: invoke(RPC_CHANNELS.locale.GET_UI_LANGUAGE),
  setUiLanguage: invoke(RPC_CHANNELS.locale.SET_UI_LANGUAGE),
  ...
  onUiLanguageChange: listener(RPC_CHANNELS.locale.CHANGED),
  ...
  getWindowFullscreenState: invoke(RPC_CHANNELS.window.GET_FULLSCREEN_STATE),
  onWindowFullscreenChange: listener(RPC_CHANNELS.window.FULLSCREEN_STATE),
