...
import type { ContentBadge } from '@zhangyuge-agent/core'
import type { MentionItemType } from '@/components/ui/mention-menu'
import type { LoadedSkill, LoadedSource } from '../../shared/types'
import { AGENTS_PLUGIN_NAME } from '@zhangyuge-agent/shared/skills/types'
...
import { parseMentions, stripAllMentions, type ParsedMentions } from '@zhangyuge-agent/shared/mentions'
