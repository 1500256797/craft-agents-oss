...
import type { StatusConfig } from '@zhangyuge-agent/shared/statuses'
import { isEmoji } from '@zhangyuge-agent/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@zhangyuge-agent/shared/colors'
import type { EntityColor } from '@zhangyuge-agent/shared/colors'
