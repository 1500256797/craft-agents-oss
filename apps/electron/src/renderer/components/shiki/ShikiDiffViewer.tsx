 ...
 * syntax highlighting. Falls back to zhangyuge-dark/zhangyuge-light (transparent bg)
 * when no Shiki theme is configured.
 */

import * as React from 'react'
import { ShikiDiffViewer as BaseShikiDiffViewer, type ShikiDiffViewerProps as BaseProps } from '@zhangyuge-agent/ui'
