 ...
 *
 * Shown when the user has existing workspaces/config but the 章鱼哥AI token
    ...
    <div className="flex min-h-screen flex-col bg-foreground-2">
      ...
      <main className="flex flex-1 items-center justify-center p-8">
        <StepFormLayout
          ...
          description={
            <>
              Your 章鱼哥AI session has expired or is no longer valid.
              <br />
              Please log in again to continue using 章鱼哥AI.
              <br />
