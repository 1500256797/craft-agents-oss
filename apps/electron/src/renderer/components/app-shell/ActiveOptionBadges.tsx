...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@zhangyuge-agent/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry } from '@zhangyuge-agent/shared/labels'
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        onCloseAutoFocus={(e) => {
          e.preventDefault()
          window.dispatchEvent(new CustomEvent('zhangyuge-agent:focus-input', {
            detail: { sessionId }
          }))
        }}
      >
