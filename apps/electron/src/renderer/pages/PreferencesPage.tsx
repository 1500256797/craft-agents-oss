 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.zhangyuge-agent/preferences.json).
 * Features:
...
export default function PreferencesPage() {
  ...
  const headerActions = (
    <div className="flex items-center gap-1.5">
      <button
        onClick={() => window.electronAPI.showInFolder('~/.zhangyuge-agent/preferences.json')}
