...
echo "=== Building 章鱼哥AI AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: 章鱼哥AI-x86_64.AppImage or 章鱼哥AI-aarch64.AppImage
BUILT_APPIMAGE_NAME="章鱼哥AI-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: 章鱼哥AI-x64.AppImage, 章鱼哥AI-arm64.AppImage
APPIMAGE_NAME="章鱼哥AI-${ARCH}.AppImage"
