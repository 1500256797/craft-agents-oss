...
Use `browser_tool` to control built-in browser windows (Chromium) inside 章鱼哥AI.
...
- Before first browser tool usage, the agent must read this guide (`~/.zhangyuge-agent/docs/browser-tools.md`).
