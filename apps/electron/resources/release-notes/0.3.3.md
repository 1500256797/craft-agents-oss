...
When your OAuth token expires, 章鱼哥AI automatically refreshes it in the background using the refresh token. No manual re-authentication required — your MCP connections stay alive.
...
Configure sources that require multiple authentication headers (e.g., API key + tenant ID). See the updated documentation at `~/.zhangyuge-agent/docs/sources.md`.
...
- Lazy loading of bundled docs fixes packaged app initialization ([zhangyuge-agent#162](https://github.com/lukilabs/zhangyuge-agent/issues/162))
...
| Issue | Title | Status |
|-------|-------|--------|
| [#80](https://github.com/lukilabs/zhangyuge-agent/issues/80) | Error invoking remote method 'update:install' | Fixed |
| [#120](https://github.com/lukilabs/zhangyuge-agent/issues/120) | Error when upgrading to newer version | Fixed |
| [#162](https://github.com/lukilabs/zhangyuge-agent/issues/162) | Missing documentation folder after install | Fixed |
...
**Full Changelog**: [v0.3.2...v0.3.3](https://github.com/lukilabs/zhangyuge-agent/compare/v0.3.2...v0.3.3)
